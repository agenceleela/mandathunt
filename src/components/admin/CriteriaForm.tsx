  ...
  return (
    <form action={formAction} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="price_min" className="block text-sm font-medium mb-1">Prix min (€)</label>
          <input
            id="price_min"
            name="price_min"
            type="number"
        ...
        <div>
          <label htmlFor="price_max" className="block text-sm font-medium mb-1">Prix max (€)</label>
          <input
            id="price_max"
            name="price_max"
            type="number"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="year_min" className="block text-sm font-medium mb-1">Année min</label>
          <input
            id="year_min"
            name="year_min"
            type="number"
        ...
        <div>
          <label htmlFor="mileage_max" className="block text-sm font-medium mb-1">Kilométrage max</label>
          <input
            id="mileage_max"
            name="mileage_max"
            type="number"
      ...
      <div className="flex items-center space-x-2">
        ...
        />
        <label htmlFor="has_phone" className="text-sm font-medium">Téléphone obligatoire</label>
      </div>
      <div className="space-y-2">
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
          />
          <label htmlFor="source_lbc" className="text-sm font-medium">leboncoin</label>
        </div>
        <div className="flex items-center space-x-2">
          <input
            type="checkbox"
            ...
            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
          />
          <label htmlFor="source_lacentrale" className="text-sm font-medium">La Centrale</label>
        </div>
      </div>
